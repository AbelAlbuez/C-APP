		...
		<body>
			<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<a class="nav-link" href="#" style="color:white!important;" data-toggle="tooltip" data-placement="bottom" title="Sobre mí"> Bienvenido, <b> Angel Reyes </b> </a>
					...
					<!-- <form class='form-inline my-2 my-lg-0' method='post'>
                        <input class='form-control mr-sm-2' type='email' placeholder='Introduce tu email' name='email' required='true'>
                        <input class='form-control mr-sm-2' type='password' placeholder='Contraseña' name='pass' required='true'>
                        <button class='btn btn-secondary my-2 my-sm-0' type='submit' name='receptor' value='header'>Ingresar</button>
                    </form> -->
